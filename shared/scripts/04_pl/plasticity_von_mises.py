...
def run_simulation(scal,eps_mac_param, comm: MPI.Intercomm):
    ...
    Sy = dolfinx.fem.Constant(domain, scalar(0.5))  # initial yield stress [GPa]
    ...
    while t <= Tend:
        ...
        if not restart_solution:
            ...
            ofile.write_function(u.sub(0), t)
            ...
            h_expr = dlfx.fem.Expression(h, ho.function_space.element.interpolation_points())
